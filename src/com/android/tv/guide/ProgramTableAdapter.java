...
//                    : R.drawable.program_guide_table_header_column_last_item_background);
            mChannelHeaderView.setBackgroundResource(R.drawable.program_guide_table_header_column_item_background);
        }
        ...
        private void onBindChannel(Channel channel) {
            ...
            if (displayNumber == null) {
                ...
                mChannelNumberView.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                        mChannelNumberView.getContext().getResources().getDimension(size) / 2);
        ...
        private void updateDetailView() {
            ...
            if (Program.isValid(mSelectedEntry.program)) {
                ...
                //This is for MCS Demo EPG title
                mTitleTextEPG.setText(program.getTitle());
        ...
        private void updatePosterArt(@Nullable Bitmap posterArt) {
            ...
            //not null
            mPosterView.setImageBitmap(posterArt);
            mPosterView.setVisibility(posterArt == null ? View.GONE : View.VISIBLE);
        }
